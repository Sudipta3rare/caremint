...
//   }
//
//   Widget listLayout(context,ListingServicesController ordCtrl,int index){
//     return Padding(
...
//                 children: [
//                   listComponetCol(ordCtrl.listService[index].categoryName!,ordCtrl.listService[index].,"Service", "Price",context),
//                 Text(ordCtrl.listService[index].cate, overflow: TextOverflow.clip,maxLines: 4,style: GoogleFonts.poppins(
//                   color: Colors.blue[900],
